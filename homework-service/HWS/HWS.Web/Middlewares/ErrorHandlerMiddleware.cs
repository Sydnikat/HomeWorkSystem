using HWS.Controllers.DTOs.Exception;
...
namespace HWS.Middlewares
{
    public class ErrorHandlerMiddleware
    {
        ...
        public class HWSException : Exception
        {
            ...
            public HWSException(string message, int statusCode, params object[] args) : base(message)
            {
